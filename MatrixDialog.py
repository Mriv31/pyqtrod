...
class MatrixChoose(QtWidgets.QDialog):
   def __init__(self, name,file=None, checked=False, icon=None, parent=None):
       ...
       vbox = QtWidgets.QVBoxLayout()
       bdb1=QtWidgets.QRadioButton("Unitary correction matrix (before data of october 2022)")
       bdb1.toggled.connect(partial(self.set_option_mat,i=0))
       bdb2=QtWidgets.QRadioButton("True optics based correction matrix (after data of october 2022)")
